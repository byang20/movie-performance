...
STORED AS TEXTFILE LOCATION 'hdfs://nyu-dataproc-m/user/bay2006_nyu_edu/hw8/output/';
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde'
STORED AS TEXTFILE LOCATION 'hdfs://nyu-dataproc-m/user/bay2006_nyu_edu/proj/fxdata/';
